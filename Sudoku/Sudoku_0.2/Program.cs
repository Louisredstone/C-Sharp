...
namespace Console_Try_1
{
    class Sudoku9x9
    {
        ...
        private Random rd = new Random(UnCheck((Int)DateTime.Now.Ticks));
        public Sudoku9x9(){
        ...
        public int solveExh(int ceiling=2){//exhaustive solve
            int cnt=0;
            //find the first '0'
            int i=0;
            for(i=0;i<81;i++){
        ...
        public void generate(){
            ...
            foreach (int index in randomList){
                ArrayList valueList0 = new ArrayList();
                int ii,rr,cc;
                bool flag=true;
                for(ii=1;ii<=9;ii++){
                    flag=true;
                    ...
                    if(flag) valueList0.Add(ii);
                }
                if (valueList0.Capacity==0) continue;
                ArrayList valueList=new ArrayList();
